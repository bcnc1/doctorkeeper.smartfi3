 ...
 */
package com.thinoo.drcamlink2.ptp.commands.eos;
...
import com.thinoo.drcamlink2.ptp.EosCamera;
import com.thinoo.drcamlink2.ptp.PacketUtil;
import com.thinoo.drcamlink2.ptp.PtpCamera.IO;
import com.thinoo.drcamlink2.ptp.PtpConstants;
import com.thinoo.drcamlink2.ptp.PtpConstants.Event;
...
public class EosEventCheckCommand extends EosCommand {
    ...
    protected void decodeData(ByteBuffer b, int length) {
        while (b.position() < length) {
            ...
            case Event.EOS_ObjectAddedUnknown: {
                int objectHandle = b.getInt();
                int storageId = b.getInt();
                int objectFormat = b.getShort();
                skip(b, eventLength - 18);
