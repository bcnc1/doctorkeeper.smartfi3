...
public class PhoneListGalleryFragment extends BaseFragment implements AdapterView.OnItemClickListener, AbsListView.OnScrollListener{
    ...
    private final String TAG = com.doctorkeeper.smartfi3.view.phonelist.PhoneListGalleryFragment.class.getSimpleName();

    public static com.doctorkeeper.smartfi3.view.phonelist.PhoneListGalleryFragment newInstance() {
        com.doctorkeeper.smartfi3.view.phonelist.PhoneListGalleryFragment f = new com.doctorkeeper.smartfi3.view.phonelist.PhoneListGalleryFragment();
        return f;
    }
