...
//    Button optionsBtn;
    ...
    private final String TAG = com.doctorkeeper.smartfi.view.phonelist.PhoneListFragment.class.getSimpleName();

    public static com.doctorkeeper.smartfi.view.phonelist.PhoneListFragment newInstance() {
        com.doctorkeeper.smartfi.view.phonelist.PhoneListFragment f = new com.doctorkeeper.smartfi.view.phonelist.PhoneListFragment();
        return f;
    }
...
//        Log.i(TAG, "CloudFragment START");
        ...
        phoneListGalleyFragment = com.doctorkeeper.smartfi.view.phonelist.PhoneListGalleryFragment.newInstance();
